...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --account miorine --broadcast --verify -vvvv
endif
...
interactRaffle:
	@forge script script/InteractRaffle.s.sol:InteractRaffle $(NETWORK_ARGS) --skip-simulation